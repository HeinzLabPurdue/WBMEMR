...
%Add in new count of levels
leftTrials = size(stim.resp,2);
stim.AveragesOLD = stim.Averages;
stim.Averages = leftTrials;
stim.totalRemovedTrials = stim.AveragesOLD - stim.Averages;
stim.RemovedTrials = trialstoRemove2;
